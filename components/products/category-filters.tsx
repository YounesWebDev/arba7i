  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:items-center" dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        <Select defaultValue={searchParams.get("filter")?.toString() || "all"} onValueChange={(val) => handleFilter("filter", val)}>
          ...
          <SelectContent align={isAr ? "start" : "end"}>
            ...
            <SelectItem value="empty">{copy.empty}</SelectItem>
          </SelectContent>
        </Select>
      </div>
    </div>
